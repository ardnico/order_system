...
- [ ] Final retrospective and cleanup.

## Surprises & Discoveries

- Observation: Test runs emit deprecation warnings from passlib's crypt backend and FastAPI's on_event decorator but do not block execution.
  Evidence: pytest warnings summary notes crypt deprecation and on_event guidance.
