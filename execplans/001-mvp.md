...
- [ ] Write README/run instructions and minimal automated tests for key flows; verify application runs (docs and tests written; runtime verification blocked until dependencies install succeeds).
- [ ] Final validation and retrospective updates.
